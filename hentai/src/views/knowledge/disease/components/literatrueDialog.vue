<template>
  <div>
    <el-dialog
      ...
      :title="dialogModel"
      :visible="openDialog"
      @close="$emit('update:openDialog', false)"
    ...
    >
      <el-form ref="dataForm" :model="form" label-position="right" label-width="100px">
        ...
        <div class="flex-box">
          ...
          >
            <el-select v-model="form.category" class="w=full" filterable>
              <el-option
...
<script>
import { getInfo, create, update, getCategory, getSource } from '@/api/knowledge/literature'
