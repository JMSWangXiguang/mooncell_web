 ...
 * @Date: 2021-08-05
 * @LastEditors: imali
 * @LastEditTime: 2022-03-07 17:22:23
-->
<template>
  <div
    style="
        ...
        <el-row style="flex: 1">
          ...
          <el-col style="height: 100%; padding-left: 20px" :span="19">
            <el-form
              ...
              class="form-box"
            >
              <el-form-item label="名称" prop="title" style="width: 90%">
              ...
              <div v-for="(item, index) in form.properties" :key="index">
                ...
                >
                  ...
                  <el-button type="primary" class="float-right" @click="edit(item)"
                    >编辑</el-button
                  >
                </el-form-item>
              </div>
