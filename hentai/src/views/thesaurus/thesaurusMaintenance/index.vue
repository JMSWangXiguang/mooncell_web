 ...
 * @LastEditors: imali
 * @LastEditTime: 2022-04-11 14:49:28
-->
<template>
  <div class="wrap">
    <el-row class="flex_box" :gutter="20">
      <el-col :span="5" style="height: 100%">
        <searchBox :sendparams="sendparams" @node-click="selectItem" />
      </el-col>
      <el-col :span="19" style="height: 100%; overflow: hidden">
        <div style="text-align: right; height: 32px">
          <!-- <el-button type="primary" class="mb-5px" @click="newBuilt">新建词汇</el-button> -->
        </div>
          ...
          <div style="flex: 2; margin-right: 20px" class="middle-content">
            ...
            >
              <el-form-item label="词汇" prop="word">
                <el-input v-model="form.word" style="width: 85%" placeholder="请输入新词汇" />
              </el-form-item>
              ...
              <div style="position: absolute; top: 20%; right: 0">
                <el-button type="primary" class="mb-5px" @click="processedUpdate">修改</el-button>
              </div>
            </el-form>
            <el-form
              ref="formHope"
            ...
            >
              <el-form-item label="标准术语" prop="mian">
                <el-input v-model="formHope.main" style="width: 85%" placeholder="请输入新词汇" />
              </el-form-item>
              ...
              <div style="position: absolute; top: 15%; right: 0">
                <el-button type="primary" class="mb-5px" @click="synonymUpdate">修改</el-button>
              </div>
            </el-form>
          </div>
